...
public class Permutator<T>
{
	 ...
	 * repeatedly exchanging elements until all of the permutations have been generated.
	 * 
	...
	/**
	 * Resets all of the internal state variables so that the generation of permutations can be restarted.
	 * 
